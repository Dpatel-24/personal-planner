...
// V6 Direction A: task-card surface. Feeds WeekBoardCard.js, the DragOverlay
// ghost card in WeekBoardView.js, and (via its own inline copy, kept in sync
// by hand) CalendarChip.js — same border/radius/background language used
// everywhere a task renders as a card, per the V6 design pass.
export const card = {
