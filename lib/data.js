...
// entry points write here: the sidebar's duration stepper (Step 7) and the
// rail's drag-resize (Step 9) — both call this one function so there's a
// single place duration ever actually gets persisted.
