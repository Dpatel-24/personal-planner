...
// Embed the parent template so we can resolve inherited title/description.
const INSTANCE_SELECT =
  '*, template:task_templates(id, title, description, recurrence_rule, start_date, end_date, active)';

// Resolve the effective title/description for an instance. One-off tasks
// (no template) and overrides carry their own text; otherwise inherit from
...
export async function createRecurringTask(
  { title, description = '', recurrenceRule, startDate, endDate = null },
  client = supabase
) {
