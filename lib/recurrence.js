...
export async function generateInstances(
  ...
  if (toInsert.length) {
    ...
    // never onto rows that already existed (those are disposable-until-touched
    // per CLAUDE.md, same as title/description; editing the template checklist
    // later must not retroactively change an already-generated instance).
