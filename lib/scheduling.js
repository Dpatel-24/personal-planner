...
// 'YYYY-MM-DD' for a Date's own LOCAL calendar day — the inverse of
// railStartFor()'s string->Date direction, needed here since cascadeLater
// only receives a proposed Date/ISO string, not a separate date-string
// param the way assignTodaySchedule does.
